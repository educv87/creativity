            ...
            {activeGalleryIndex === 0 ? (
              ...
              <div className="relative w-full h-full z-20 transition-transform duration-500 hover:scale-105 flex items-center justify-center rounded-[2rem] overflow-hidden drop-shadow-xl">
                ...
                {galleryImages[activeGalleryIndex].needsTint && (
                  <div className={`absolute inset-0 w-full h-full mix-blend-multiply opacity-90 transition-colors duration-500 rounded-[2rem] ${activeColor.name.toLowerCase() === 'negro' ? 'bg-[#404247]' : activeColor.tint}`}></div>
                )}
              </div>
            )}
          </div>
                ...
                {index === 0 ? (
                  ...
                  <div className="w-full h-full bg-gray-50 flex items-center justify-center relative group">
                    ...
                    {(item.needsTint || item.isVideo) && (
                      <div className={`absolute inset-0 w-full h-full mix-blend-multiply opacity-90 ${item.isVideo ? 'bg-black/20' : (activeColor.name.toLowerCase() === 'negro' ? 'bg-[#404247]' : activeColor.tint)}`}></div>
                    )}
                      ...
                      {selectedShipping && (
                        <div className="mt-8 bg-white border-2 border-gray-100 rounded-[2rem] p-6 md:p-10 shadow-[0_20px_50px_-12px_rgba(0,0,0,0.1)] text-gray-900 animate-fade-in-up">
                          ...
                          <p className="text-center text-xs font-medium text-gray-400 mt-4 flex items-center justify-center gap-1">
                            ...
                            Tus pagos están 100% encriptados y protegidos por Mercado Pago.
                          </p>

                          {/* Certeza de envio y soporte directo */}
                          <div className="mt-6 pt-5 border-t border-gray-100 flex flex-col gap-3 text-xs">
                            <div className="flex flex-wrap items-center justify-center gap-3 text-gray-600 font-bold">
                              <span className="flex items-center gap-1 text-emerald-700 bg-emerald-50 px-2.5 py-1 rounded-lg">🚚 Envío Rastreable 24/7</span>
                              <span className="flex items-center gap-1 text-blue-700 bg-blue-50 px-2.5 py-1 rounded-lg">🛡️ Stock Real BIND ERP</span>
                            </div>
                            <a 
                              href={`https://wa.me/524427844291?text=${encodeURIComponent("¡Hola! Estoy en la página de pago de creatividad.mx y tengo una duda antes de finalizar mi pedido.")}`}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="bg-emerald-500 hover:bg-emerald-600 text-white font-bold py-3 px-4 rounded-xl text-center flex items-center justify-center gap-2 shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5"
                            >
                              <svg className="w-5 h-5 fill-current" viewBox="0 0 448 512">
                                <path d="M380.9 97.1C339 55.1 283.2 32 223.9 32c-122.4 0-222 99.6-222 222 0 39.1 10.2 77.3 29.6 111L0 480l117.7-30.9c32.4 17.7 68.9 27 106.1 27h.1c122.3 0 224.1-99.6 224.1-222 0-59.3-25.2-115-67.1-157zm-157 341.6c-33.2 0-65.7-8.9-94-25.7l-6.7-4-69.8 18.3L72 359.2l-4.4-7c-18.5-29.4-28.2-63.3-28.2-98.2 0-101.7 82.8-184.5 184.6-184.5 49.3 0 95.6 19.2 130.4 54.1 34.8 34.9 56.2 81.2 56.1 130.5 0 101.8-84.9 184.6-186.6 184.6zm101.2-138.2c-5.5-2.8-32.8-16.2-37.9-18-5.1-1.9-8.8-2.8-12.5 2.8-3.7 5.6-14.3 18-17.6 21.8-3.2 3.7-6.5 4.2-12 1.4-5.6-2.8-23.6-8.7-45-27.7-16.6-14.9-27.9-33.3-31.1-38.9-3.2-5.6-.3-8.6 2.5-11.4 2.5-2.5 5.6-6.5 8.3-9.8 2.8-3.2 3.7-5.6 5.6-9.3 1.9-3.7.9-6.9-.5-9.8-1.4-2.8-12.5-30.1-17.1-41.3-4.5-10.8-9.1-9.3-12.5-9.5-3.2-.2-6.9-.2-10.6-.2-3.7 0-9.7 1.4-14.8 6.9-5.1 5.6-19.4 19-19.4 46.3 0 27.3 19.9 53.7 22.6 57.4 2.8 3.7 39.1 59.7 94.8 83.8 13.2 5.8 23.5 9.2 31.5 11.8 13.3 4.2 25.4 3.6 35 2.2 10.7-1.6 32.8-13.4 37.4-26.4 4.6-13 4.6-24.1 3.2-26.4-1.3-2.5-5-3.9-10.5-6.6z" />
                              </svg>
                              ¿Dudas antes de pagar? Chatea por WhatsApp
                            </a>
                          </div>
                        </div>
                      )}
